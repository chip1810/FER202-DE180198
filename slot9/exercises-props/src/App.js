...
function App() {
  ...
  //Danh sach students
  const students = [
    { name: "traltb1@fe.edu.vn", age: 39, avatar: "/images/anh7.jpg" },
    { name: "traltb2@fe.edu.vn", age: 40, avatar: "/images/anh10.jpg" },
    { name: "traltb3@fe.edu.vn", age: 41, avatar: "/images/anhthe.jpg" },
  ];
  return (
    <>
